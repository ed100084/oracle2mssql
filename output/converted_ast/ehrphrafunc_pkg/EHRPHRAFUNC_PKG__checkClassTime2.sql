CREATE OR ALTER FUNCTION [ehrphrafunc_pkg].[checkClassTime2]
...
DECLARE cursor2 CURSOR FOR
    ...
    FROM HRP.HRA_CLASSDTL
      ...
      IF ((DATEADD(MILLISECOND, 8640, CONVERT(DATETIME2, @p_start_date + @p_start_time))
         ...
         CONVERT(DATETIME2, @p_end_date + @p_end_time)) BEGIN
        SET @RtnCode = 1;
      END
    ...
    OPEN cursor2;
    WHILE 1=1 BEGIN
      FETCH NEXT FROM cursor2 INTO @iCHKIN_WKTM, @iCHKOUT_WKTM, @iSTART_REST, @iEND_REST;
      IF @@FETCH_STATUS <> 0 BREAK;
